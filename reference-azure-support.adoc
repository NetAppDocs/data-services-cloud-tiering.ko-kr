...
summary: NetApp Cloud Tiering 두 가지 액세스 계층과 대부분의 지역을 지원합니다. 
---
= NetApp Cloud Tiering 에 지원되는 Azure Blob 액세스 계층 및 지역
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
NetApp Cloud Tiering 두 가지 액세스 계층과 대부분의 지역을 지원합니다.
